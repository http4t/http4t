...
export class MapLens<A,B, TMessage extends HttpMessage = HttpMessage> implements MessageLens<TMessage, B> {
    constructor(private readonly a: MessageLens<TMessage, A>,
                private readonly getter: (a: A) => Promise<RoutingResult<B>>,
...
export function mapped<A,B, TMessage extends HttpMessage = HttpMessage>(
    a: MessageLens<TMessage,A>,
    getter: (a: A) => Promise<RoutingResult<B>>,
